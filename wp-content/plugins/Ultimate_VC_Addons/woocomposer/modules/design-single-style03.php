...
function woocomposer_single_style03( $atts ) {
	...
	if ( '' !== $ult_design_single03['sale_price'] ) {
		$sale_price_size = 'font-size:' . intval( $ult_design_single03['sale_price'] ) . 'px;';
	}
	$ult_design_single03['img_animate'] = 'wcmp-img-' . sanitize_key( $ult_design_single03['img_animate'] );

	if ( '' !== $ult_design_single03['border_style'] ) {
		$border .= 'border:' . intval( $ult_design_single03['border_size'] ) . 'px ' . esc_attr( $ult_design_single03['border_style'] ) . ' ' . esc_attr( $ult_design_single03['border_color'] ) . ';';
		$border .= 'border-radius:' . intval( $ult_design_single03['border_radius'] ) . 'px;';
	}
	if ( '' !== $ult_design_single03['color_product_desc_bg'] ) {
		$desc_style .= 'background:' . esc_attr( $ult_design_single03['color_product_desc_bg'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_product_desc'] ) {
		$desc_style .= 'color:' . esc_attr( $ult_design_single03['color_product_desc'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_heading'] ) {
		$heading_style = 'color:' . esc_attr( $ult_design_single03['color_heading'] ) . ';';
	}
	if ( '' !== $ult_design_single03['size_title'] ) {
		$heading_style .= 'font-size:' . esc_attr( $ult_design_single03['size_title'] ) . 'px;';
	}
	if ( '' !== $ult_design_single03['color_categories'] ) {
		$cat_style = 'color:' . esc_attr( $ult_design_single03['color_categories'] ) . ';';
	}
	if ( '' !== $ult_design_single03['size_cat'] ) {
		$cat_style .= 'font-size:' . esc_attr( $ult_design_single03['size_cat'] ) . 'px;';
	}
	if ( '' !== $ult_design_single03['color_price'] ) {
		$price_style = 'color:' . esc_attr( $ult_design_single03['color_price'] ) . ';';
	}
	if ( '' !== $ult_design_single03['size_price'] ) {
		$price_style .= 'font-size:' . intval( $ult_design_single03['size_price'] ) . 'px;';
	}
	if ( '' !== $ult_design_single03['color_rating'] ) {
		$rating_style .= 'color:' . esc_attr( $ult_design_single03['color_rating'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_rating_bg'] ) {
		$rating_style .= 'background:' . esc_attr( $ult_design_single03['color_rating_bg'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_quick_bg'] ) {
		$view_bg_style = 'background:' . esc_attr( $ult_design_single03['color_quick_bg'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_quick'] ) {
		$view_style = 'color:' . esc_attr( $ult_design_single03['color_quick'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_cart_bg'] ) {
		$cart_bg_style = 'background:' . esc_attr( $ult_design_single03['color_cart_bg'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_cart'] ) {
		$cart_style = 'color:' . esc_attr( $ult_design_single03['color_cart'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_on_sale_bg'] ) {
		$label_style = 'background:' . esc_attr( $ult_design_single03['color_on_sale_bg'] ) . ';';
	}
	if ( '' !== $ult_design_single03['color_on_sale'] ) {
		$label_style .= 'color:' . esc_attr( $ult_design_single03['color_on_sale'] ) . ';';
	}
	...
	$output    .= "\n" . '<div class="wcmp-product woocommerce wcmp-' . esc_attr( $ult_design_single03['product_style'] ) . ' ' . esc_attr( $ult_design_single03['img_animate'] ) . '" style="' . esc_attr( $border ) . ' ' . esc_attr( $desc_style ) . '">';
	...
	if ( '' !== $on_sale ) {
		$output .= "\n" . '<div class="wcmp-onsale ' . esc_attr( $ult_design_single03['on_sale_alignment'] ) . ' ' . esc_attr( $ult_design_single03['on_sale_style'] ) . '"><span class="onsale" style="' . esc_attr( $label_style ) . ' ' . esc_attr( $sale_price_size ) . '">' . $on_sale . '</span></div>';
	}
	if ( 'OutOfStock' == $stock ) {
	...
	if ( in_array( 'category', $elemets ) ) {
		...
		$output .= '</h5>';
			...
			$output .= '<div class="wcmp-add-to-cart" style="' . esc_attr( $cart_bg_style ) . '"><a style="' . esc_attr( $cart_style ) . '" title="Add to Cart" href="?add-to-cart=' . esc_attr( $ult_design_single03['product_id'] ) . '" rel="nofollow" data-product_id="' . esc_attr( $ult_design_single03['product_id'] ) . '" data-product_sku="" class="button add_to_cart_button product_type_simple">Add to Cart</a></div>';
	...
	if ( in_array( 'quick', $elemets ) ) {
		$output .= '<div class="wcmp-quick-view quick-view-single" style="' . esc_attr( $view_bg_style ) . '"><a style="' . esc_attr( $view_style ) . '" title="Quick View" href="' . get_permalink( $ult_design_single03['product_id'] ) . '"><i class="wooicon-plus32"></i></a></div>';
	}
