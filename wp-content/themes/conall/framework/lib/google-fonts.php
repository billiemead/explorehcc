<?php
if (!function_exists('conall_edge_init_google_fonts_array')) {
    function conall_edge_init_google_fonts_array()
    {

        global $conall_edge_fonts_array;
        $conall_edge_fonts_array =
            array(
                0   =>
                array(
                ...
                array(
                    ...
                    'files'        =>
                    array(
                        100       => 'http://fonts.gstatic.com/s/',
                        200       => 'http://fonts.gstatic.com/s/',
                        300       => 'http://fonts.gstatic.com/s/',
                        'regular' => 'http://fonts.gstatic.com/s/',
                        500       => 'http://fonts.gstatic.com/s/',
                        600       => 'http://fonts.gstatic.com/s/',
                        700       => 'http://fonts.gstatic.com/s/',
                        800       => 'http://fonts.gstatic.com/s/',
                        900       => 'http://fonts.gstatic.com/s/',
                    ),
                ), */
            );
    }
    add_action('after_setup_theme', 'conall_edge_init_google_fonts_array');
}